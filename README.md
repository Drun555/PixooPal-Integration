...
Add this repository to HACS as **Integration**, install it, restart Home Assistant, then add **PixooPal** from **Settings -> Devices & services**. Default PixooPal WebUI port: `5173`
...
Custom card for clockface's inputs:
